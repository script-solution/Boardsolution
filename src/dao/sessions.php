 ...
 *
 * @version			$Id: sessions.php 796 2008-05-29 18:23:27Z nasmussen $
...
class BS_DAO_Sessions extends PLIB_Singleton
{
	...
	{
		$this->db->sql_insert(BS_TB_SESSIONS,$fields);
	...
	{
		$this->db->sql_update(BS_TB_SESSIONS,'WHERE session_id = "'.$sid.'"',$fields);
