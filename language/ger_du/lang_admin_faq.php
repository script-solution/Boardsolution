...
$LANG["faq_a_board_logo"] = "Das Board-Logo ist mittels CSS eingestellt. Du kannst dies in der Designanpassung &auml;ndern. Also zun&auml;chst bei <b>Theme-Verwaltung</b> -> <b>Themes</b> bei dem gew&uuml;nschten Theme auf \"Editieren\" klicken. Dann links bei <b>Gruppen</b> die Gruppe <b>Haupt-Klassen</b> -> <b>Board-Logo</b> ausw&auml;hlen und dort den Pfad des Bildes &auml;ndern oder was immer Du m&ouml;chtest.";
$LANG["faq_a_moderators"] = "Moderatoren sind daf&uuml;r da um dem/den Administrator(en) ein wenig Arbeit abzunehmen. Du kannst f&uuml;r jedes Forum, welches Themen enth&auml;lt, ein oder mehrere Moderatoren unter <b>Forum-Verwaltung</b> -> <b>Moderatoren</b> festlegen.<br />
...
Die M&ouml;glichkeiten, die die Moderatoren haben, kannst Du bei <b>Allgemein</b> -> <b>Einstellungen</b> -> <b>Moderatoren</b> einstellen.<br />
...
Du kannst aber GZip im Adminbereich einfach kurz aktivieren um zu testen ob es funktioniert. Sofern das Board \"normal\" geladen wird und keine kryptischen Zeichen zu sehen sind, l&auml;uft alles wie es soll.<br />
Sofern Dein Server es unterst&uuml;tzt ist es empfehlenswert es zu aktivieren.<br />
<br />
...
$LANG["faq_a_link_to_hp"] = "Dies kannst Du in den Templates machen.<br />
...
<ul>
	...
	<li>Ca. bei Zeile 25 der Datei siehst Du folgendes:<br />"
 ...
 .'</pre>'
 ."</li>
	<li>Dort kannst Du einen weiteren Men&uuml;-Punkt in folgender Art und Weise einf&uuml;gen:<br />"
 .'<pre style="margin-top: 10px; padding: 4px; border: 1px solid #999999; background-color: #FFFFFF; font-family: Courier New, Monospace; font-size: 12px;">'
 .htmlspecialchars('<table width="100%" cellpadding="2" cellspacing="1" style="table-layout: fixed;">
	<tr>
 ...
 .'</pre>'
 ."</li>
	<li>Wobei die ID des Links (hier \"link20\") eindeutig sein muss. D.h. wenn Du mehrere Links hinzuf&uuml;gen m&ouml;chtest, m&uuml;sstest Du immer einen anderen, bisher nicht verwendeten Wert nehmen.<br />
Dann nur noch abspeichern und danach sollte der soeben erstellte Men&uuml;punkt sichtbar sein.</li>
</ul>";
$LANG["faq_a_status_messages"] = "Du kannst in der <b>config/actions.php</b> festlegen nach welcher Aktion eine sogenannte \"Status-Seite\" angezeigt werden soll.<br />
...
&Ouml;ffne bitte zun&auml;chst die config/bbcode.php. Bei Zeile 300 findest Du folgendes:
<pre style=\"margin-top: 10px; margin-bottom: 5px; padding: 4px; border: 1px solid #999999; background-color: #FFFFFF; font-family: Courier New, Monospace; font-size: 12px;\">
...
	'right' => array(
		'tag' => 'right',
...
<pre style=\"margin-top: 10px; margin-bottom: 5px; padding: 4px; border: 1px solid #999999; background-color: #FFFFFF; font-family: Courier New, Monospace; font-size: 12px;\">
\$LANG['bbcode_help_pre'] = 'Vorformatierter Text: [pre]dein Text[/pre]';
</pre>
( Nat&uuml;rlich mit, je nach Sprache, variierendem Wert )<br />
<br />
Jetzt solltest Du den hingef&uuml;gten Tag noch bei Adminbereich -&gt; Einstellungen -&gt; Formatierung f&uuml;r die gew&uuml;nschten Bereiche freischalten.<br />
Das wars :-)";
$LANG["faq_a_subforums"] = "Auch das kannst Du in der <b>config/userdef.php</b> einstellen. Der Wert, der daf&uuml;r verantwortlich ist, ist folgender:<br />
<div style=\"margin-top: 10px; margin-bottom: 5px; padding: 4px; border: 1px solid #999999; background-color: #FFFFFF; font-family: Courier New, Monospace; font-size: 12px;\">
define('BS_FORUM_SMALL_SUBDIR_DISPLAY',3);
</div>
Hier einfach die Zahl am Ende so &auml;ndern wie Du es gerne h&auml;ttest.<br />
Diese Einstellung hat nur einen Effekt sofern in den Einstellungen \"Alle Unterforen anzeigen\" auf \"Nein\" gestellt ist!";
$LANG["faq_a_reduce_userdata"] = "Du kannst einmal bei <b>Zus&auml;tzliche Profilfelder</b> einige Angaben entfernen.<br />
Falls Du noch mehr Angaben entfernen m&ouml;chtest, kannst Du dies in den Templates machen. Damit Du nicht lange suchen musst, hier ein Beispiel:<br />
...
<ul>
	...
	<li>ca. in der Mitte der Datei kannst Du die User-Daten sehen, die angezeigt werden:<br />"
	.'<pre style="margin-top: 10px; padding: 4px; border: 1px solid #999999; background-color: #FFFFFF; font-family: Courier New, Monospace; font-size: 12px;">'
.htmlspecialchars('
...
$LANG['faq_a_logout'] = 'Wenn Du auf Logout klickst und auf der n&auml;chsten Seite immer noch eingeloggt
bist, ist wahrscheinlich der <b>Cookie-Pfad</b> oder die <b>Cookie-Domain</b> falsch eingestellt.<br />
Du kannst dies bei <b>Einstellungen -> Allgemein</b> &auml;ndern. Beide Werte sind dort erkl&auml;rt.<br />
Nachdem Du dies ge&auml;ndert hast, <b>l&ouml;sche</b> bitte einmal die <b>Cookies von Boardsolution</b> (Sie fangen mit 
...
erh&auml;lt.<br />
Wenn das so ist, kannst Du den User auch manuell im Adminbereich aktivieren.';
$LANG['faq_a_bs_api'] = 'Wenn Du ein paar Informationen aus dem Board auf Deiner Homepage oder irgendwo anders anzeigen
m&ouml;chtest, kannst Du daf&uuml;r die <b>BS-API</b> benutzen, wenn Du m&ouml;chtest. Dies gibt Dir ein einfaches Interface
...
Bitte wirf einen Blick auf das Beispiel (<b>extern/example.php</b>) um zu verstehen wie die API genutzt werden kann.<br />
Wenn Du alle verf&uuml;gbaren Daten in der API wissen m&ouml;chtest, dann schau bitte in die Module (extern/modules). Alle Daten stehen
dort in den Feldern der Klassen (die var $... Statements am Anfang).';
$LANG['faq_a_bbceditor_extra_tags'] = 'Du kannst die "Extra-Tags" des Java-BBCodeEditors in
<b>bbceditor/extra_tags.xml</b> konfigurieren. Dort sind bereits 4 bestehende Tags: "post", "topic", "att" und "attimg".<br />
Du kannst diese Datei beliebig erweitern. Beachte, dass es auch m&ouml;glich ist neue Buttons hinzuzuf&uuml;gen (mit Extra-Tags).<br />
Wenn Du etwas wie "gui.a.b..." siehst, ist dies ein Eintrag in den Sprach-Dateien des Java-BBCodeEditors (bbceditor/language/&lt;sprache&gt;.txt).<br />
<br />
Lasst uns nun einen zus&auml;tzlichen Tag in der Datei hinzuf&uuml;gen. Zuerst kopieren wir eines der existierenden Items und editieren es f&uuml;r unseren Tag:
<pre style="margin-top: 10px; padding: 4px; border: 1px solid #999999; background-color: #FFFFFF; font-family: Courier New, Monospace; font-size: 12px;">'
.htmlspecialchars('
<item name="example">
...
')
.'</pre>
Beachte, dass der Tag "hasParameter" angibt ob der BBCode-Tag einen Parameter hat oder nicht. Also ob
...
<b>Aber beachte, dass Du evtl. den Browser neustarten musst, falls Du bereits den Editor im Browser benutzt hast, denn viele Browser speichern Java-Applets zwischen.</b>';
?>
