...
$LANG['step1_explain'] = '<span style="font-weight: bold; color: #FF0000; font-size: 13px;">Bitte lesen Sie sich diese Hinweise durch um
sp&auml;teren Problemen und Fragen vorzubeugen!</span>';
$LANG['step2_explain'] = 'Falls Sie schon Boardsolution v1.2x installiert haben, w&auml;hlen Sie hier bitte "Update".<br />
Wenn Sie eine &auml;ltere Version installiert haben, z.B. Boardsolution v1.1x, m&uuml;ssen Sie Schrittweise "updaten". D.h. Sie m&uuml;ssen
...
<b>Aus dem Grund sollten Sie keine Manuellen &Auml;nderungen an der Datenbankstruktur vorgenehmen</b>,
sofern Sie nicht genau wissen was Sie tun!<br />
<br />
Der sogenannte "DB-Cache" kann allerdings im Adminbereich neu berechnet werden.<br />
D.h. wenn Sie Ver&auml;nderungen an der Datenbankstruktur durchf&uuml;hren, sollten Sie (je nach dem welche
Tabelle Sie ge&auml;ndert haben) den Cache der Tabelle unter Wartung -> DB-Cache neu berechnen.<br />
<br />
...
$LANG['error']['chmod_cache'] = 'Stellen Sie bitte die Zugriffsrechte von "cache" so ein, dass es beschreibbar ist (z.B. 0777).';
$LANG['error']['chmod_config'] = 'Stellen Sie bitte die Zugriffsrechte von "config" so ein, dass es beschreibbar ist (z.B. 0777).';
$LANG['error']['chmod_config_community'] = 'Stellen Sie bitte die Zugriffsrechte von "config/community.php" so ein, dass es beschreibbar ist (z.B. 0666).';
$LANG['error']['chmod_config_userdef'] = 'Stellen Sie bitte die Zugriffsrechte von "config/userdef.php" so ein, dass es beschreibbar ist (z.B. 0666).';
$LANG['error']['chmod_themes'] = 'Stellen Sie bitte die Zugriffsrechte von "themes/&lt;theme&gt;/style.css" und allen Dateien in "themes/default/templates" so ein, dass sie beschreibbar sind (z.B. 0666).';
...
$LANG['error']['chmod_smileys'] = 'Stellen Sie bitte die Zugriffsrechte von "images/smileys" so ein, dass es beschreibbar ist (z.B. 0777).';
$LANG['error']['chmod_avatars'] = 'Stellen Sie bitte die Zugriffsrechte von "images/avatars" so ein, dass es beschreibbar ist (z.B. 0777).';
$LANG['error']['chmod_uploads'] = 'Stellen Sie bitte die Zugriffsrechte von "uploads" so ein, dass es beschreibbar ist (z.B. 0777).';
$LANG['error']['chmod_dbbackup'] = 'Stellen Sie bitte die Zugriffsrechte von "dbbackup/backups" so ein, dass es beschreibbar ist (z.B. 0777).';
$LANG['error']['chmod_dbaaccess'] = 'Stellen Sie bitte die Zugriffsrechte von "dbbackup" so ein, dass es beschreibbar ist (z.B. 0777).';
...
$LANG['error']['admin_login'] = 'Bitte geben Sie den Usernamen des Administrators an.';
$LANG['error']['admin_pw'] = 'Bitte geben Sie das Passwort des Administrators an.';
$LANG['error']['admin_email'] = 'Bitte geben Sie die Email-Adresse des Administrators an.';
$LANG['error']['board_url'] = 'Bitte geben Sie den Board-Pfad an.';
...
$LANG['board_url_desc'] = 'Die absolute URL zu Ihrem Board. D.h., wenn Boardsolution z.B. hier liegt: "http://www.domain.de/board/index.php", dann w&auml;re die URL: "http://www.domain.de/board"<br />
...
$LANG['important_tasks'] = '<b>WICHTIG:</b> Bitte aktualisieren Sie die Nachrichten gleich als Erstes! Sie k&ouml;nnen dies bei Adminbereich -> Wartung -> Verschiedenes tun. Werfen Sie bitte vorher noch ein Blick auf die Einstellungen (insbesondere Einstellungen -&gt; Formatierung). Danach sollten Sie in Adminbereich -&gt; Wartung -&gt; Nachrichten korrigieren ggf. fehlerhafte Nachrichten berichtigen.';

$LANG['table_exists_error'] = 'Wenn Sie eine Vollinstallation durchf&uuml;hren wollen, darf keine Tabelle bereits vorhanden sein.<br />Falls Sie das Board ein weiteres Mal in dieser Datenbank installieren wollen oder aus anderen Gr&uuml;nden die selbe Datenbank nutzen m&ouml;chten, k&ouml;nnen Sie oben auf dieser Seite das "Tabellen-Pr&auml;fix" ver&auml;ndern.';
