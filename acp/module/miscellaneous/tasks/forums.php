 ...
 *
 * @version			$Id: forums.php 741 2008-05-24 12:04:56Z nasmussen $
 ...
 * @author			Nils Asmussen <nils@script-solution.de>
 */
final class BS_ACP_Miscellaneous_Tasks_Forums extends PLIB_FullObject implements PLIB_Progress_Task
{
	/**
	...
	{
		foreach(BS_DAO::get_forums()->get_all('id','ASC',$pos,$ops) as $data)
		{
