<?php
/**
 * Contains the standalone-class for the user-experience-image
 * 
 * @version			$Id: user_experience.php 713 2008-05-20 21:59:54Z nasmussen $
 ...
 * @author			Nils Asmussen <nils@script-solution.de>
 */
final class BS_Front_Standalone_user_experience extends BS_Standalone
{
	...
	public function run()
	{
		...
		else
		{
			...
			$rank = $this->functions->get_rank_data($userdata['exppoints']);
		}
		...
		switch($this->cfg['post_stats_type'])
		{
			case 'current_rank':
				$bar_start = 0;
			...
			case 'continuous':
				...
				{
					$this->cache->get_cache('user_ranks')->to_last();
					$last_rank = $this->cache->get_cache('user_ranks')->current();
				}
