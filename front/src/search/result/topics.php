 ...
 *
 * @version			$Id: topics.php 676 2008-05-08 09:02:28Z nasmussen $
 ...
 * @author			Nils Asmussen <nils@script-solution.de>
 */
final class BS_Front_Search_Result_Topics extends PLIB_FullObject implements BS_Front_Search_Result
{
	...
	{
		return $this->locale->lang('no_topics_found');
	}
